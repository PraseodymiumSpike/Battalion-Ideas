...
Extra-Strength Battalions may only be selected in Party Mode with the Assassin Gamemode or FFA Gamemode when there are more than 2 Players playing who are not using Crab Battalion.
### Assassin Gamemode
...
### Chameleon
These rules only apply in Party Mode, so you can skip this section if you do not need to learn rules for Party Mode.
