...
### Fireball
Moves without Capturing an unlimited number of Spaces along Queen Lines, Captures 1 Space along Queen Lines, Mandatorily Captures itself when Capturing another Piece 
## Special Ability
...
## Starting Territory
![Starting Territory](https://github.com/user-attachments/assets/95370e6e-e7e9-4ac7-b3cc-af12f0d3decf)
